...
const yargs = __nccwpck_require__(5387);
const createKeyPair_1 = __nccwpck_require__(4560);
const createOktaServiceApp_1 = __nccwpck_require__(2872);
const grantAppScopes_1 = __nccwpck_require__(955);
const parser = yargs(process.argv.slice(2)).options({
    domain: {
        type: 'string',
        demandOption: true,
        describe: 'Your Okta API Domain, omit HTTPS://',
    },
    token: {
        type: 'string',
        demandOption: true,
...
function createAppAndScopes() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const key = yield (0, createKeyPair_1.createKeyPair)(keySize);
        try {
            const clientId = yield (0, createOktaServiceApp_1.createOktaServiceApp)(oktaDomain, oktaToken, oktaAppName, key, kid);
            if (clientId) {
                setTimeout(() => console.log(`New app ${oktaAppName} successfully generated.\nYour client_id is ${clientId}\n`), 250);
                yield Promise.all(scopes.map((s) => (0, grantAppScopes_1.grantAppScopes)(oktaDomain, oktaToken, clientId, s)));
                console.log(`App has these scopes ${scopes}`);
            }
        }
        catch (err) {
            console.error(`@indent.createAppAndScopes: failed`);
            console.error(err);
        }
    });
}
...
function createKeyPair(keySize = 2048) {
    return __awaiter(this, void 0, void 0, function* () {
        // convert genkeypair to promise
        const generateAsyncKeyPair = (0, util_1.promisify)(crypto_1.generateKeyPair);
        // set options
        const keyOptions = {
        ...
        // create key objects
        const { publicKey, privateKey } = yield generateAsyncKeyPair('rsa', keyOptions);
        setTimeout(() => console.log(`Generating an RSA JSON Web Key with ${keySize} bits of entropy`), 500);
        return yield promises_1.default
            .writeFile('jwk.json', `${JSON.stringify(publicKey)}\n${JSON.stringify(privateKey)}`)
            .then(() => {
            setTimeout(() => console.log(`Keys successfully written to file "jwk.json"`), 500);
            return publicKey;
        });
    });
}
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.createOktaServiceApp = void 0;
const axios_1 = __importDefault(__nccwpck_require__(6545));
function createOktaServiceApp(oktaDomain, oktaToken, oktaAppName, key, kid) {
    return __awaiter(this, void 0, void 0, function* () {
        // Add a key ID
        const signingKey = Object.assign(Object.assign({}, key), { kid, use: 'sig' });
        ...
        }).then((r) => { var _a; return (_a = r.data) === null || _a === void 0 ? void 0 : _a.client_id; });
    });
}
exports.createOktaServiceApp = createOktaServiceApp;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.grantAppScopes = void 0;
const axios_1 = __importDefault(__nccwpck_require__(6545));
function grantAppScopes(oktaDomain, oktaToken, clientId, scopeId) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield (0, axios_1.default)({
            method: 'post',
...
exports.grantAppScopes = grantAppScopes;
...
/******/ 	var __webpack_exports__ = __nccwpck_require__(__nccwpck_require__.s = 4822);
